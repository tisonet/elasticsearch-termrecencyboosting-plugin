...
/**
 * Tests against all decorated TF-IDF based similarities. Copied from Lucene source codes, but added our similarities.
 * see org.apache.lucene.search.similarities.TestSimilarity2
 */
public class SimilarityTests extends LuceneTestCase {
